...
public class Personalize_GamerParameterLabel extends JPanel {

    private final int[] padletWrapper;

    public Personalize_GamerParameterLabel(String proposition, int padlet, JCheckBox dependencies, Boolean visible, Consumer<String> variableUpdater) {
        ...
        padletLabel.setForeground(new Color(68, 62, 185));
        ...
        changePadlet.setForeground(new Color(68, 62, 185));
        ...
        changePadlet.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                changePadlet.setForeground(new Color(55, 42, 150)); // Changer la couleur de fond au survol
            }

            @Override
            public void mouseExited(MouseEvent e) {
                changePadlet.setForeground(new Color(68, 62, 185)); // Changer la couleur de fond au desurvol
            }
        });
